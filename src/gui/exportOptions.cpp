...
void FurnaceGUI::drawExportASM(bool onWindow) {
  ...
  ImGui::RadioButton(_("AMPS##ampsstyle"), &smpsStyle, 2);
  ...
  ImGui::RadioButton(_("SMPS 68k##68kvib"), &smpsVibrato, 0);
  ImGui::RadioButton(_("SMPS Z80##z80vib"), &smpsVibrato, 1);
  ImGui::RadioButton(_("AMPS##ampsvib"), &smpsVibrato, 2);
  ImGui::Text(_("PSG Pitch:"));
  ImGui::RadioButton(_("SMPS 68k##68kpit"), &smpsPSGPitch, 0);
  ImGui::RadioButton(_("SMPS Z80##z80pit"), &smpsPSGPitch, 1);
